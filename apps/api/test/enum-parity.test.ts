...
const PAIRS: ReadonlyArray<[string, readonly string[], Record<string, string>]> = [
  ...
  ['PropertyCondition', shared.propertyConditionSchema.options, prismaEnums.PropertyCondition],
  ['SellerType', shared.sellerTypeSchema.options, prismaEnums.SellerType],
  ['AreaUnit', shared.areaUnitSchema.options, prismaEnums.AreaUnit],
